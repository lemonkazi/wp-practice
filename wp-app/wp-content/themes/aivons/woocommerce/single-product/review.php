...
<div <?php comment_class( ' product-review__item ' ); ?> id="li-comment-<?php comment_ID(); ?>">
	<div class="product-review__item__image">
		<?php echo get_avatar( $comment, apply_filters( 'woocommerce_review_gravatar_size', '166' ), '' ); ?>
	</div><!-- /.product-review__item__image -->
	<?php if ( '0' === $comment->comment_approved ) { ?>
		<div class="product-review__item__content">
			<p class="meta">
				<em class="woocommerce-review__awaiting-approval">
					<?php esc_html_e( 'Your review is awaiting approval', 'aivons' ); ?>
				</em>
			</p>
		</div>
	<?php }else{ ?>
		<div class="product-review__item__content">
			...
			<div class="product-review__item__top">
